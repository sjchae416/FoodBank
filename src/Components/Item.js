...
export default function RequestItem(props) {
	...
	const percentage =
		...
		100;
	const requiredFood =
		props.data.companyData.requiredFood - props.data.companyData.donatedFood;
	return (
		<Item>
			<Stack direction="row" spacing={2} sx={{ px: 1 }}>
				<Avatar
					src={props.data.companyData.imgURL}
				...
				<Stack spacing={1} sx={{ width: 300 }}>
					...
					<Typography>
						{props.data.companyData.donatedFood} /{' '}
						{props.data.companyData.requiredFood}
					</Typography>
				</Stack>
				<Format
					buttonName="Donate"
